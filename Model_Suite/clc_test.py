...
def run_case_level(args):
    ...
    # embeds = {split: create_doc_embeddings(model, submodel_args.model_args['model_type'], loader, device)
    #           for split, loader in data_loaders.items()}

    datasets = dw.make_grouped_cases(outputs, clc_params.model_args, device)
