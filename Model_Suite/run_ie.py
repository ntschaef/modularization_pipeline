...
from validate import exceptions, validate_params
...
def run_ie(args=None):
    ...
    evaluator = predictions.ScoreModel(valid_params.model_args, data_loaders, dw, model, device, savepath=save_path)
    ...
    evaluator.evaluate_model(dw.metadata['metadata'], dw.dict_maps['id2label'], dac=dac, save_probs=False)
